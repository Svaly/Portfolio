...
namespace Portfolio.WebUI.Infrastructure
{
    public static class FileHelper
    {
            ...
            public static void SaveResizedImage(string filePath, string thumbnailPath , int width, int height)
            {
                Image origImg = Image.FromFile(filePath);
                Image resizedImg = FixedSize(origImg, width, height);

                resizedImg.Save(thumbnailPath);
                resizedImg.Dispose();
                origImg.Dispose();
            }
